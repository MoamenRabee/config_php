...
if (isset($_GET['shell']) && !FM_READONLY) {
    ...
    <div class="path">
        <div class="row">
            <div class="col-12">
                <h3><i class="fa fa-terminal"></i> Web Shell</h3>
                <p class="text-muted">Current Directory: <code><?php echo fm_enc($cwd); ?></code></p>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-dark text-white">
                        <i class="fa fa-terminal"></i> Command Executor
                    </div>
                    <div class="card-body">
                        <form method="post" action="?p=<?php echo urlencode(FM_PATH) ?>&shell=1">
                            <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="command" id="command" 
                                           value="<?php echo fm_enc($command); ?>" 
                                           placeholder="ls -la" autofocus>
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-play"></i> Execute
                                    </button>
                                </div>
                                <small class="form-text text-muted">
                                    Examples: ls -la, pwd, whoami, cat file.txt, ps aux
                                </small>
                            </div>
                        </form>
                        ...
                        <div class="mt-4">
                            <h5>Command:</h5>
                            <pre class="bg-dark text-white p-3 rounded"><code><?php echo fm_enc($command); ?></code></pre>
                            
                            <h5 class="mt-3">Output:</h5>
                            <pre class="bg-dark text-white p-3 rounded" style="max-height: 500px; overflow-y: auto;"><code><?php echo fm_enc($output); ?></code></pre>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="btn-group-vertical w-100" role="group">
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='pwd'; document.querySelector('form').submit();">
                                    <i class="fa fa-folder"></i> pwd - Print working directory
                                </button>
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='ls -la'; document.querySelector('form').submit();">
                                    <i class="fa fa-list"></i> ls -la - List files (detailed)
                                </button>
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='whoami'; document.querySelector('form').submit();">
                                    <i class="fa fa-user"></i> whoami - Current user
                                </button>
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='uname -a'; document.querySelector('form').submit();">
                                    <i class="fa fa-info-circle"></i> uname -a - System information
                                </button>
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='df -h'; document.querySelector('form').submit();">
                                    <i class="fa fa-hdd-o"></i> df -h - Disk space usage
                                </button>
                                <button type="button" class="btn btn-outline-secondary text-start" onclick="document.getElementById('command').value='ps aux'; document.querySelector('form').submit();">
                                    <i class="fa fa-tasks"></i> ps aux - Running processes
                                </button>
                            </div>
                        </div>
